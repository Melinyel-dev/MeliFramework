 ...
 *
 */
class Carbon extends DateTimeFrench {
    ...
    /**
     * Partitive articles of seasons
     */
    public static $seasonsArticle = array(
        self::SPRING => 'du printemps',
        self::SUMMER => 'de l\'été',
        self::AUTUMN => 'de l\'automne',
        self::WINTER => 'de l\'hiver'
    );
    ...
    public static function validate($date, $format = 'Y-m-d H:i:s') {
        $dateCarbon = self::createFromFormat($format, $date);
        return $dateCarbon && $dateCarbon->format($format) == $date;
    }
    ...
    /**
     * Format the instance as SQL date
     *
     * @return string
     */
    public function toDateSql() {
     ...
     * @return string
     */
    public function toFormattedDateTimeString() {
        return $this->format('l j F Y à H:i:s');
    }

    /**
     * Format the instance as a readable short date
     *
     * @return string
     */
    public function toFormattedShortDateString() {
        if ($this->year == Carbon::now()->year) return $this->format('l j F');
        return $this->format('D j M Y');
    }
    ...
    public function toDateTimeString() {
        return $this->format('d/m/Y à H:i:s');
    }

    /**
     * Format the instance as SQL date and time
     *
     * @return string
     */
    public function toDateTimeSql() {
